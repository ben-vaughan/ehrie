...
df = pd.read_csv("./data/Laboratories.csv")

for row in df.itertuples():
    

    query = """INSERT INTO Laboratories (laboratory_id, name, address, phone) VALUES ({}, '{}', '{}', '{}')
    """.format(row.laboratory_id, re.sub("'", '"', row.name), row.address, row.phone)
